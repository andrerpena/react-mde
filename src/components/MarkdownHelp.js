...
const MarkdownHelp = ({ helpText = 'Markdown styling is supported', markdownReferenceUrl = 'http://commonmark.org/help/' }) => <a className="markdown-help" href={markdownReferenceUrl} target="_blank">
