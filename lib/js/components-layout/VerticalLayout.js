    ...
    VerticalLayout.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "react-mde-vertical-layout" },
            ...
            React.createElement("div", { className: "react-mde-content" },
                ...
                React.createElement(components_1.MdePreview, { className: classNames(finalLayoutOptions.previewClassName), previewRef: function (c) { return _this.previewRef = c; }, html: mdeEditorState ? mdeEditorState.html : "", emptyPreviewHtml: emptyPreviewHtml }))));
    };
