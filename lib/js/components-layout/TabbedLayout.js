...
var TabbedLayout = /** @class */ (function (_super) {
    ...
    TabbedLayout.prototype.render = function () {
        var _this = this;
        var _a = this.props, buttonContentOptions = _a.buttonContentOptions, commands = _a.commands, mdeEditorState = _a.mdeEditorState, emptyPreviewHtml = _a.emptyPreviewHtml, readOnly = _a.readOnly, otherProps = _a.otherProps, cleanHtml = _a.cleanHtml;
        ...
        return (React.createElement("div", { className: "react-mde-tabbed-layout" },
            ...
            currentTab === exports.TAB_CODE ?
                ...
                :
                    React.createElement(components_1.MdePreview, { previewRef: function (c) { return _this.previewRef = c; }, html: mdeEditorState ? mdeEditorState.html : "", emptyPreviewHtml: emptyPreviewHtml, cleanHtml: cleanHtml })));
    };
    return TabbedLayout;
}(React.Component));
